...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (player.paused) return replyInteractionEmbed(interaction, '', 'The player is already paused.', 'DARK_RED');

    await player.pause(true);
    setEmbed(interaction.guild, player);
    return replyInteractionEmbed(interaction, '', 'Paused the player.', 'DARK_GREEN');
  },
};
