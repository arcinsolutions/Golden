    ...
    async execute(client) {
        ...
        console.log(
            colors.green('            │ ') +
                ' Guilds:   ' +
                stats[0] +
                ' '.repeat(text.length - stats[0].length - 12) +
                colors.green('│ ')
        )
        console.log(
            colors.green('            │ ') +
                ' User:     ' +
                stats[1] +
                ' '.repeat(text.length - stats[1].length - 12) +
                colors.green('│ ')
        )
        console.log(
            colors.green('            │ ') +
                ' Channels: ' +
                stats[2] +
                ' '.repeat(text.length - stats[2].length - 12) +
                colors.green('│ ')
        )
        ...
        console.log(
            colors.green('            │ ') +
                ' Commands: ' +
                stats[3] +
                ' '.repeat(text.length - stats[3].length - 12) +
                colors.green('│ ')
        )
        console.log(
            colors.green('            │ ') +
                ' Events:   ' +
                stats[4] +
                ' '.repeat(text.length - stats[4].length - 12) +
                colors.green('│ ')
        )
        console.log(colors.green('            ╰' + underline[0] + '╯'))
